...
void SoftArmControl::handleMovjClosedLoopIOCoupled()
{
...
void SoftArmControl::handleMovjClosedLoopIOUncoupled()
{
    std::vector<double> x_imu;
    double polarError,
           azimuthError,
...
void SoftArmControl::handleMovjClosedLoopRPUncoupled(){
